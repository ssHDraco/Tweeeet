...
from hashtags.signals import parsed_hashtag
...
class Tweet(models.Model):
	...
	#	return super(Tweet, self).clean(*arg, **kwargs)
...
def tweet_save_receiver(sender, instance, created, *args, **kwargs):
	if created and not instance.parent:
		...
		parsed_hashtag.send(sender=instance.__class__, hashtag_list=hashtags)
